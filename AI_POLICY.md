...
We support using AI (such as LLMs) as tools when contributing to
python-solaredged. However, you are responsible for any contributions you
submit, and we are responsible for any contributions we merge and release. We
hold a high bar for all contributions to this project.

Maintainers dedicate their time and expertise to reviewing contributions.
...
**We do not allow autonomous agents to be used for contributing to this
project.** We will close any pull requests or issues that we believe were
...
communicate your intent. We may hide any comments that we believe are unreviewed
AI output.
...
must be in a quote block (such as using `>`) and disclosed as such. It must be
accompanied by your own commentary explaining the relevance and implications of
...
the translation accurately reflects your intent. Including your original text in
a details block shows the effort behind your contribution, helps maintainers
verify the translation if needed, and keeps the conversation readable.

## Code and documentation contributions

AI can be a helpful tool for writing code and documentation. However, due to the
foundational open source nature of this project, we require a human in the loop
...
This project uses AI tools to assist with code reviews, issue triaging,
reporting, and other project management tasks. These tools may leave comments on
pull requests or issues. As with any automated tooling, these comments are not
always correct.
...
Contributions that do not follow this policy will be closed. Repeated violations
may result in being blocked from contributing to this project. If you believe
your contribution was closed in error, you are welcome to reach out to a
