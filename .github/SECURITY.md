...
[**Report a vulnerability**](https://github.com/frenck/python-solaredged/security/advisories/new)
...
- Issues in the SolarEdge inverter firmware itself; please report those
  directly to [SolarEdge](https://www.solaredge.com/).
- Denial-of-service or data-exposure conditions resulting from malformed or
  hostile responses over the Modbus connection. This library assumes the
  configured device and network are trusted.

## Scope

This security policy covers the `solaredged` Python package published on
[PyPI](https://pypi.org/project/solaredged/) and its source code in this
repository.
